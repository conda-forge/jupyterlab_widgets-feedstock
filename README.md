...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab_widgets-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10883&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab_widgets-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab_widgets` can be installed with:

```
conda install jupyterlab_widgets
```

It is possible to list all of the versions of `jupyterlab_widgets` available on your platform with:
